...
export class ListSchoolSaturdaysController {
  constructor(
    private readonly listSchoolSaturdaysUseCase: ListSchoolSaturdaysUseCase
  ) {}
  ...
  async handle(
    ...
    try {
      ...
      const response = await this.listSchoolSaturdaysUseCase.execute(params);
